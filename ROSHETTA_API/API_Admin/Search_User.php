...
if ($_SERVER['REQUEST_METHOD'] == 'GET' || isset($_SESSION['admin'])) { //Allow Access Via 'GET' Method Or Admin
    ...
    if (isset($_SESSION['admin'])) {
        ...
        if (isset($_GET['search']) && ! empty($_GET['search'])) {
            ...
            $get_patient = $database->prepare("SELECT id,name,ssd,profile_img,role  FROM patient WHERE patient.ssd = :search OR patient.name = :search OR email = :search ");
            ...
            $get_doctor = $database->prepare("SELECT id,name,ssd,profile_img,role  FROM doctor WHERE doctor.ssd = :search OR doctor.name = :search OR email = :search ");
            ...
            $get_pharmacist = $database->prepare("SELECT id,name,ssd,profile_img,role  FROM pharmacist WHERE pharmacist.ssd = :search OR pharmacist.name = :search OR email = :search ");
            ...
            $get_assistant = $database->prepare("SELECT id,name,ssd,profile_img,role  FROM assistant WHERE assistant.ssd = :search OR assistant.name = :search OR email = :search ");
