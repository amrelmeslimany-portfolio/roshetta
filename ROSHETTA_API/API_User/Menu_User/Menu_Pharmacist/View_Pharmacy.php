    ...
    if (isset($_SESSION['pharmacist'])) {
        ...
        if ($checkActivation->rowCount() > 0) {
            ...
            if ($Activation->isactive == 1) {
                ...
                $get_pharmacy = $database->prepare("SELECT id as pharmacy_id,logo as pharmacy_logo,pharmacy.name as pharmacy_name,start_working,end_working FROM pharmacy WHERE pharmacist_id = :pharmacist_id ORDER BY start_working ");
