            ...
            if (
                ...
                if ($_POST['password'] == $_POST['confirm_password']) {
                    ...
                    if (filter_var($ssd, FILTER_VALIDATE_INT) !== FALSE) {
                        ...
                        $checkssd = $database->prepare("SELECT * FROM patient WHERE ssd =:ssd");
                        ...
                        if ($checkssd->rowCount() > 0) {
                            ...
                            $addData = $database->prepare("INSERT INTO patient(patient_name,ssd,phone_number,gender,birth_date,weight,height,governorate,password,role)
                                                                        VALUES(:patient_name,:ssd,:phone_number,:gender,:birth_date,:weight,:height,:governorate,:password,'PATIENT')");
            ...
            if (
                ...
                if ($_POST['password'] == $_POST['confirm_password']) {
                    ...
                    if (filter_var($ssd, FILTER_VALIDATE_INT) !== FALSE) {
                        ...
                        $checkssd = $database->prepare("SELECT * FROM doctor WHERE ssd =:ssd");
                        $checkssd->bindparam("ssd", $ssd);
                        $checkssd->execute();
                        ...
                        if ($checkssd->rowCount() > 0) {
                            ...
                            if ($check_phone->rowCount() > 0) {
                                ...
                                $addData = $database->prepare("INSERT INTO doctor(doctor_name,gender,ssd,phone_number,birth_date,password,specialist,governorate,role)
                                                                                VALUES(:doctor_name,:gender,:ssd,:phone_number,:birth_date,:password,:specialist,:governorate,'DOCTOR')");
            ...
            if (
                ...
                if ($_POST['password'] == $_POST['confirm_password']) {
                    ...
                    if (filter_var($ssd, FILTER_VALIDATE_INT) !== FALSE) {
                        ...
                        $checkssd = $database->prepare("SELECT * FROM pharmacist WHERE ssd =:ssd");
                        $checkssd->bindparam("ssd", $ssd);
                        $checkssd->execute();
                        ...
                        if ($checkssd->rowCount() > 0) {
                            ...
                            if ($check_phone->rowCount() > 0) {
                                ...
                                $addData = $database->prepare("INSERT INTO pharmacist(pharmacist_name,gender,ssd,phone_number,birth_date,password,governorate,role)
                                                                            VALUES(:pharmacist_name,:gender,:ssd,:phone_number,:birth_date,:password,:governorate,'PHARMACIST')");
            ...
            if (
                ...
                if ($_POST['password'] == $_POST['confirm_password']) {
                    ...
                    if (filter_var($ssd, FILTER_VALIDATE_INT) !== FALSE) {
                        ...
                        $checkssd = $database->prepare("SELECT * FROM assistant WHERE ssd =:ssd");
                        $checkssd->bindparam("ssd", $ssd);
                        $checkssd->execute();
                        ...
                        if ($checkssd->rowCount() > 0) {
                            ...
                            if ($check_phone->rowCount() > 0) {
                                ...
                                $addData = $database->prepare("INSERT INTO assistant(assistant_name,gender,ssd,phone_number,birth_date,password,governorate,role)
                                                                                VALUES(:assistant_name,:gender,:ssd,:phone_number,:birth_date,:password,:governorate,'ASSISTANT')");
