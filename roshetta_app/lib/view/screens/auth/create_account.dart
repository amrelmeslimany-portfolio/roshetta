...
class CreateAccount extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AuthLayout(
        ...
        widget: GetBuilder<CreateAccControllerImp>(builder: (controller) {
          return Column(
              ...
              Form(
                ...
                child: CustomRequest(
                  ...
                  widget: Column(
                    children: [
                      const DividerText(
                          text: "البيانات الشخصيه", color: Colors.white),
                      ...
                      const SizedBox(height: 15),
                      const DividerText(
                          text: "اختر الجنس", color: Colors.white),
                      const SizedBox(height: 10),
                      SizedBox(
                        width: 320,
                        child: Row(
                      ...
                      CustomTextField(
                          ...
                          .textfield,
                      const SizedBox(height: 15),
                      const DividerText(text: "العنوان", color: Colors.white),
                      const SizedBox(height: 10),
                      CustomDropdown(
                          context: context,
                      ...
                      const SizedBox(height: 15),
                      const DividerText(
                          text: "بيانات الحساب", color: Colors.white),
                      const SizedBox(height: 10),
                      CustomDropdown(
                          context: context,
                      ...
                      CustomRequest(
                        ...
                        widget: AccountTypeWidget(
                            specialistValue: controller.doctorSpecialist,
                      ...
                      CustomTextField(
                        ...
                        onValidator: (value) {
                          return fieldValidor(value!,
                              ...
                              passwordsEquals:
                                  controller.checkPasswordEquals());
                        },
